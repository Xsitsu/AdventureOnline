...
void PrintEmployees(char driver[])
{
	...
	SQLHANDLE hstmt;
	SDWORD cbQual;
	char* query = "execute ReadNPCInfo 1";
	char ename[100];
	SQLRETURN retcode;
	...
	sprintf((char *)InConnStr, "driver={%s}; Server=aura.students.cset.oit.edu;Database=jose_morenodedios;uid=jose_morenodedios;pwd=shaedar2123", driver);
